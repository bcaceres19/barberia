...
Las capturas verifican composición, no sustituyen las aserciones de comportamiento. Los snapshots visuales, si se incorporan después, se actualizan solo tras revisar la diferencia. La herramienta de automatización accesible se seleccionará con la misma justificación exigida a cualquier dependencia; mientras no exista, la revisión manual sigue siendo obligatoria según [estandar-diseno-visual.md](estandar-diseno-visual.md).
