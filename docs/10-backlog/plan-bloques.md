...
| **B3** | Agenda del barbero, estados e integridad | 11 | `HU-060` – `HU-0xx` | `HU-060`–`HU-065` integradas; `HU-066` cancelación T6 implementada, [PR #235](https://github.com/bcaceres19/barberia/pull/235) abierto pendiente de CI/merge ([#225](https://github.com/bcaceres19/barberia/issues/225)); `HU-067` cierre manual T4/T7 ([#226](https://github.com/bcaceres19/barberia/issues/226)) y `HU-068` corrección T8 ([#227](https://github.com/bcaceres19/barberia/issues/227)) redactadas y bloqueadas por secuencia |
...
**Secuencia redactada:** `HU-060` núcleo persistente y exclusión PostgreSQL → `HU-061` creación manual → `HU-062` agenda diaria de hoy → `HU-063` navegación por fecha → `HU-064` detalle e historial → `HU-065` reprogramación auditada T2 → `HU-066` cancelación por barbero T6 → `HU-067` cierre manual T4/T7 → `HU-068` corrección auditada T8. `HU-060`–`HU-065` están integradas en `main`. El tercer lote usa únicamente semánticas confirmadas: `HU-066` está implementada contra [#225](https://github.com/bcaceres19/barberia/issues/225) ([PR #235](https://github.com/bcaceres19/barberia/pull/235) abierto, pendiente de CI/merge); `HU-067` ([#226](https://github.com/bcaceres19/barberia/issues/226)) espera su integración y `HU-068` ([#227](https://github.com/bcaceres19/barberia/issues/227)) espera ambas. T3 y cierre automático permanecen pendientes porque requieren un lote posterior que precise, respectivamente, snapshots/precio/duración y configuración de modo/demora.
...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-065` integradas, `HU-066` implementada ([PR #235](https://github.com/bcaceres19/barberia/pull/235) abierto, pendiente de CI/merge) (#225), `HU-067`/`HU-068` redactadas y bloqueadas por secuencia (#226/#227); T3, cierre automático y B4–B6 pendientes |
