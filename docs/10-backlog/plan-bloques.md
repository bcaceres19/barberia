...
| Historias restantes de B1 a B6 | B2: `HU-040` integrada en `main` ([PR #93](https://github.com/bcaceres19/barberia/pull/93)); `HU-041` integrada en `main` ([PR #96](https://github.com/bcaceres19/barberia/pull/96)); `HU-042` redactada y `draft`; B3–B6 pendientes y se redactan al cerrar el bloque anterior |
