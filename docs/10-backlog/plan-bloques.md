...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-067` integradas ([PR #235](https://github.com/bcaceres19/barberia/pull/235) #225, [PR #237](https://github.com/bcaceres19/barberia/pull/237) #226), `HU-068` redactada y bloqueada por secuencia (#227); B4: `HU-090`–`HU-099` redactadas como propuesta en #240, bloqueadas por B3 y decisiones abiertas; B5–B6 pendientes |
