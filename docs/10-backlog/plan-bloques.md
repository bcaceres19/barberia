...
| **B4** | Reserva pública y disponibilidad | 13 | `HU-090` – `HU-099` | Diez HU redactadas como propuesta; implementación bloqueada |
...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-068` integradas ([PR #235](https://github.com/bcaceres19/barberia/pull/235) #225, [PR #237](https://github.com/bcaceres19/barberia/pull/237) #226, [PR #239](https://github.com/bcaceres19/barberia/pull/239) #227), tercer lote completo; B4: `HU-090`–`HU-099` redactadas como propuesta en #240, bloqueadas por decisiones abiertas; T3, cierre automático y B5–B6 pendientes |
...
Redactar historias muy por anticipado está desaconsejado. El propietario solicitó el 2026-09-10 un lote explícito de diez HU; por ello `HU-090`–`HU-099` se conservan como propuesta documental y sus prompts como `draft`, sin iniciar B4 ni omitir el criterio de salida de B3.
