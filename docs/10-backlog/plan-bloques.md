...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-062` integradas, `HU-063` implementada (issue [#116](https://github.com/bcaceres19/barberia/issues/116)), `HU-064` implementada (issue [#120](https://github.com/bcaceres19/barberia/issues/120)), PR abierto pendiente de CI; `HU-065` redactada como propuesta con prompt `draft`, bloqueada por `HU-064` integrada y por `DP-CIT-06`; `HU-066` y siguientes, B4–B6 pendientes |
