...
| **B3** | Agenda del barbero, estados e integridad | 11 | `HU-060` – `HU-0xx` | `HU-060`–`HU-066` integradas ([PR #235](https://github.com/bcaceres19/barberia/pull/235), [#225](https://github.com/bcaceres19/barberia/issues/225)); `HU-067` cierre manual T4/T7 implementada, [PR #237](https://github.com/bcaceres19/barberia/pull/237) abierto pendiente de CI/merge ([#226](https://github.com/bcaceres19/barberia/issues/226)); `HU-068` corrección T8 ([#227](https://github.com/bcaceres19/barberia/issues/227)) redactada y bloqueada por secuencia |
...
**Secuencia redactada:** `HU-060` núcleo persistente y exclusión PostgreSQL → `HU-061` creación manual → `HU-062` agenda diaria de hoy → `HU-063` navegación por fecha → `HU-064` detalle e historial → `HU-065` reprogramación auditada T2 → `HU-066` cancelación por barbero T6 → `HU-067` cierre manual T4/T7 → `HU-068` corrección auditada T8. `HU-060`–`HU-066` están integradas en `main` ([PR #235](https://github.com/bcaceres19/barberia/pull/235)). El tercer lote usa únicamente semánticas confirmadas: `HU-067` está implementada contra [#226](https://github.com/bcaceres19/barberia/issues/226) ([PR #237](https://github.com/bcaceres19/barberia/pull/237) abierto, pendiente de CI/merge); `HU-068` ([#227](https://github.com/bcaceres19/barberia/issues/227)) espera su integración. T3 y cierre automático permanecen pendientes porque requieren un lote posterior que precise, respectivamente, snapshots/precio/duración y configuración de modo/demora.
...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-066` integradas ([PR #235](https://github.com/bcaceres19/barberia/pull/235), #225), `HU-067` implementada ([PR #237](https://github.com/bcaceres19/barberia/pull/237) abierto, pendiente de CI/merge) (#226), `HU-068` redactada y bloqueada por secuencia (#227); T3, cierre automático y B4–B6 pendientes |
