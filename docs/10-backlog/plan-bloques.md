...
| Historias restantes de B1 a B6 | B2: `HU-040` integrada en `main` ([PR #93](https://github.com/bcaceres19/barberia/pull/93)); `HU-041` integrada en `main` ([PR #96](https://github.com/bcaceres19/barberia/pull/96)); `HU-042` `in_progress` (issue [#98](https://github.com/bcaceres19/barberia/issues/98), rama `feat/98-hu042-bloqueos-agenda`); B3–B6 pendientes y se redactan al cerrar el bloque anterior |
