...
| **B3** | Agenda del barbero, estados e integridad | 11 | `HU-060` – `HU-0xx` | `HU-060`–`HU-062` integradas; `HU-063` navegación por fecha implementada (issue real [#116](https://github.com/bcaceres19/barberia/issues/116)), integrada en `main` mediante [PR #118](https://github.com/bcaceres19/barberia/pull/118); `HU-064` detalle/historial implementada (issue real [#120](https://github.com/bcaceres19/barberia/issues/120)), integrada en `main` mediante [PR #121](https://github.com/bcaceres19/barberia/pull/121); `HU-065` reprogramación auditada (T2) implementada contra el issue real [#123](https://github.com/bcaceres19/barberia/issues/123) (`DP-CIT-06` resuelta como `DEC-076`), integrada en `main` mediante [PR #125](https://github.com/bcaceres19/barberia/pull/125) |
...
**Secuencia redactada:** `HU-060` núcleo persistente y exclusión PostgreSQL → `HU-061` creación manual → `HU-062` agenda diaria de hoy → `HU-063` navegación por fecha → `HU-064` detalle e historial → `HU-065` reprogramación auditada T2. Las tres primeras están integradas mediante PR #105, #109 y #113. El segundo lote se redactó después de revisar esas bases: reutiliza el parámetro `date` ya existente, hace visible el historial append-only antes de añadir acciones y agrega una sola transición de escritura. `HU-063` tiene issue real ([#116](https://github.com/bcaceres19/barberia/issues/116)) y está implementada en `feat/116-hu063-navegacion-agenda`, integrada en `main` mediante [PR #118](https://github.com/bcaceres19/barberia/pull/118). `HU-064` tiene issue real ([#120](https://github.com/bcaceres19/barberia/issues/120)) e integrada en `main` mediante [PR #121](https://github.com/bcaceres19/barberia/pull/121). `DP-CIT-06` quedó resuelta el 2026-09-01 como `DEC-076` (bloqueo duro frente a un intervalo bloqueado); `HU-065` tiene issue real ([#123](https://github.com/bcaceres19/barberia/issues/123)) y está implementada, en `feat/123-hu065-reprogramacion-turno`, integrada en `main` mediante [PR #125](https://github.com/bcaceres19/barberia/pull/125). T3, cancelación, completar, `no_show`, corrección y cierre automático siguen pendientes de redacción.
...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-062` integradas, `HU-063` implementada (issue [#116](https://github.com/bcaceres19/barberia/issues/116)), `HU-064` implementada (issue [#120](https://github.com/bcaceres19/barberia/issues/120)); `HU-065` implementada (issue [#123](https://github.com/bcaceres19/barberia/issues/123)), integrada en `main` mediante [PR #125](https://github.com/bcaceres19/barberia/pull/125); `HU-066` y siguientes, B4–B6 pendientes |
...
Redactar historias muy por anticipado está desaconsejado: lo aprendido al construir cambia lo que la historia siguiente debe decir. Por eso el segundo lote de B3 termina en `HU-065`; `HU-066` y siguientes se redactan después de implementar y revisar navegación, detalle/historial y T2. B4 solo se redacta cuando B3 cumpla su criterio de salida.
