...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-065` integradas, `HU-066` `ready` (#225), `HU-067`/`HU-068` redactadas y bloqueadas por secuencia (#226/#227); T3, cierre automático y B4–B6 pendientes |
