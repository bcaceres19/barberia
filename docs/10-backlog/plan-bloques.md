...
| **B3** | Agenda del barbero, estados e integridad | 11 | `HU-060` – `HU-0xx` | `HU-060`–`HU-062` integradas; `HU-063` navegación por fecha implementada (issue real [#116](https://github.com/bcaceres19/barberia/issues/116)), integrada en `main` mediante [PR #118](https://github.com/bcaceres19/barberia/pull/118); `HU-064` detalle/historial implementada (issue real [#120](https://github.com/bcaceres19/barberia/issues/120)), integrada en `main` mediante [PR #121](https://github.com/bcaceres19/barberia/pull/121); `HU-065` reprogramación auditada con issue real [#123](https://github.com/bcaceres19/barberia/issues/123) y prompt `ready` (`DP-CIT-06` resuelta como `DEC-076`), sin implementar |
...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-062` integradas, `HU-063` implementada (issue [#116](https://github.com/bcaceres19/barberia/issues/116)), `HU-064` implementada (issue [#120](https://github.com/bcaceres19/barberia/issues/120)); `HU-065` con issue real [#123](https://github.com/bcaceres19/barberia/issues/123) y prompt `ready` (`DP-CIT-06` resuelta como `DEC-076`), sin implementar; `HU-066` y siguientes, B4–B6 pendientes |
