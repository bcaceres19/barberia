...
| Historias restantes de B1 a B6 | B2: `HU-040`–`HU-042` integradas; B3: `HU-060`–`HU-062` integradas, `HU-063` implementada (issue [#116](https://github.com/bcaceres19/barberia/issues/116)), `HU-064` implementada (issue [#120](https://github.com/bcaceres19/barberia/issues/120)); `HU-065` implementada (issue [#123](https://github.com/bcaceres19/barberia/issues/123)), [PR #125](https://github.com/bcaceres19/barberia/pull/125) abierto, pendiente de CI; `HU-066` y siguientes, B4–B6 pendientes |
