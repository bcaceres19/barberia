...
| [PROMPT-TEST-OTP-EMAIL-RESEND-v1](test/issue-86-otp-correo-resend.md) | `test` | `HU-008`, `HU-011` | [#86](https://github.com/bcaceres19/barberia/issues/86) | `blocked` | Adaptador de correo único, selección por ambiente y pruebas automatizadas integradas en `main`; prueba manual con correo real pendiente (requiere credenciales Resend del operador, no se ejecuta desde el agente) | Rama `test/86-otp-correo-resend`; [PR #130](https://github.com/bcaceres19/barberia/pull/130) fusionado con `Refs #86` |
