...
| [PROMPT-HU-008-v1](hu/hu-008-recuperacion-acceso.md) (v1.4) | `hu` | `HU-008` | [#58](https://github.com/bcaceres19/barberia/issues/58) | `in_progress` | `DEC-063`–`DEC-066` resuelven `DP-SEG-11`/`DP-SEG-12`/`CT-006`/`DP-NOT-05`; `HU-007` integrada en `main` | `feat/58-hu008-recuperacion-acceso` / — |
