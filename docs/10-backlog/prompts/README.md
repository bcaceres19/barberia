...
| --- | --- | --- | --- | --- | --- | --- |
| [PROMPT-ORCH-NAVA-FRONTEND-v1.4](orchestration/adopcion-frontend-nava.md) | `orchestration` | `HU-005`–`HU-012`, `HU-020`–`HU-024`, `HU-040`–`HU-042`, `HU-060`–`HU-065`; futuras solo con HU real | `pending` | `draft` | `DEC-077`–`DEC-079`; incluye el inventario de las 11 rutas P0, contrato visual, ejecución por issue/PR y un mensaje de autorización persistente para continuar después de Fase 0 sin confirmaciones rutinarias | Sin rama/PR; prompt maestro para Claude Code, no autoriza una migración masiva |
