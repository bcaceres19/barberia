...
| [PROMPT-HU-063-v1](hu/hu-063-navegacion-agenda.md) (v1.1) | `hu` | `HU-063` | [#116](https://github.com/bcaceres19/barberia/issues/116) | `ready` | `HU-062` integrada; issue real creado y enlazado | Rama sugerida `feat/116-hu063-navegacion-agenda`; sin PR aún |
