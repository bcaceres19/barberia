...
| [PROMPT-HU-012-v1](hu/hu-012-cascaron-panel-privado.md) (v1.2) | `hu` | `HU-012` | [#56](https://github.com/bcaceres19/barberia/issues/56) | `executed` | `HU-006`/`HU-009`/`HU-010` integradas; `DP-SEG-09` resuelta (`DEC-060`) | `feat/56-hu012-cascaron-panel` / PR pendiente de abrir |
| [PROMPT-HU-007-v1](hu/hu-007-defensa-abuso.md) | `hu` | `HU-007` | [#57](https://github.com/bcaceres19/barberia/issues/57) | `blocked` | Secuencia tras `HU-012`; `DP-SEG-10` y `CT-005` abiertas | — |
| [PROMPT-HU-008-v1](hu/hu-008-recuperacion-acceso.md) | `hu` | `HU-008` | [#58](https://github.com/bcaceres19/barberia/issues/58) | `blocked` | `HU-007` pendiente; `DP-NOT-05`, `DP-SEG-11`, `DP-SEG-12` y `CT-006` abiertas | — |
