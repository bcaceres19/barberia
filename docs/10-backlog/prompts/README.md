...
| --- | --- | --- | --- | --- | --- | --- |
| [PROMPT-ORCH-NAVA-FRONTEND-v1.4](orchestration/adopcion-frontend-nava.md) | `orchestration` | `HU-005`–`HU-012`, `HU-020`–`HU-024`, `HU-040`–`HU-042`, `HU-060`–`HU-065`; futuras solo con HU real | [#168](https://github.com/bcaceres19/barberia/issues/168) | `ready` | `DEC-077`–`DEC-079` integradas en `main` (issue #166/PR #167); Fase 0 auditó las 13 filas del inventario: fundaciones, shell, acceso/recuperación, agenda diaria, nuevo turno, barberos, horarios y bloqueos cumplen `DEC-079`; detalle/historial/reprogramación, configuración, servicios y servicios por barbero solo tienen fixes de tokens y requieren issue hijo propio | Sin rama/PR propios; prompt maestro para Claude Code, no autoriza una migración masiva |
...
| [PROMPT-CHORE-171-CATALOGO-SERVICIOS-NAVA-v1](chore/issue-171-catalogo-servicios-nava.md) | `chore` | `HU-022`, `HU-024` | [#171](https://github.com/bcaceres19/barberia/issues/171) | `ready` | Fase 9 (issue maestro #168); confirma con evidencia real que la pantalla ya cumple `DEC-079`; añade `vitest-axe` en el error de carga y evidencia/axe en vivo | Rama `feat/171-catalogo-servicios-nava`; sin PR todavía |
