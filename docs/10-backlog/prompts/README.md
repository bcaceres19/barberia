...
| [PROMPT-HU-011-v1](hu/hu-011-pantalla-recuperacion.md) | `hu` | `HU-011` | [#64](https://github.com/bcaceres19/barberia/issues/64) | `ready` | `HU-008`/`HU-009`/`HU-010` integradas en `main` | — |
