...
| [PROMPT-HU-005-v1](hu/hu-005-inicio-sesion.md) (v1.2) | `hu` | `HU-005` | [#44](https://github.com/bcaceres19/barberia/issues/44) | `in_progress` | `HU-002`/`HU-003` integradas; `CT-003` resuelta (`DEC-055`) | `feat/44-hu005-inicio-sesion` |
