...
| [PROMPT-CHORE-CONTROLES-REGLADOS-SHARED-UI-v1](chore/issue-pending-controles-reglados-shared-ui.md) | `chore` | `HU-009`; relacionadas `HU-010`–`HU-012` | [#212](https://github.com/bcaceres19/barberia/issues/212) | `ready` | Fase 1 de `PROMPT-ORCH-LENGUAJE-REGLADO-NAVA-v1`. Solo visual: campo reglado, `OtpInput` nuevo, alerta como nota al margen y botones en `shared/ui`, más barrido de regresión en las once rutas P0. Exige Claude Sonnet 5/high y las skills `nava-mockup-fidelity` + `browser-viewport-verification` | Rama prevista `chore/212-controles-reglados-shared-ui`; sin PR todavía |
