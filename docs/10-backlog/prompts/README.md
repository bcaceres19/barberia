...
| [PROMPT-HU-063-v1](hu/hu-063-navegacion-agenda.md) | `hu` | `HU-063` | `pending` | `draft` | `HU-062` integrada; falta issue real propio | Sin rama/PR; no ejecutar mientras `issue: pending` |
