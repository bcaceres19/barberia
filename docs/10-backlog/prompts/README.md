...
| [PROMPT-HU-042-v1](hu/hu-042-bloqueos-agenda.md) | `hu` | `HU-042` | [#98](https://github.com/bcaceres19/barberia/issues/98) | `executed` | `HU-040`/`HU-041` integradas; `CT-008` resuelta (`DEC-070`); backend completo y probado contra PostgreSQL real, frontend parcial (falta UI de `date_list`/excepciones/edición de serie y E2E) | Rama `feat/98-hu042-bloqueos-agenda`; [PR #99](https://github.com/bcaceres19/barberia/pull/99), aún no integrada en `main` |
