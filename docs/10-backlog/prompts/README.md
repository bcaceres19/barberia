...
| [PROMPT-HU-024-v1](hu/hu-024-ciclo-vida-servicios.md) | `hu` | `HU-024` | [#77](https://github.com/bcaceres19/barberia/issues/77) | `in_progress` | `HU-022`/`HU-023` integradas; `DP-SER-03` resuelta (`DEC-069`) | Rama `feat/77-hu024-ciclo-vida-servicios`; PR pendiente de apertura |
