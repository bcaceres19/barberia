...
| [PROMPT-HU-020-v1](hu/hu-020-configuracion-barberia.md) | `hu` | `HU-020` | [#67](https://github.com/bcaceres19/barberia/issues/67) | `executed` | Criterio de salida de B0 verificado 2026-08-23 (CI verde sobre `main` `a57354b`); PR abierto, pendiente de CI/merge | `feat/67-hu020-configuracion-barberia` / [PR #70](https://github.com/bcaceres19/barberia/pull/70) |
