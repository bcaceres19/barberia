...
| [PROMPT-HU-064-v1](hu/hu-064-detalle-historial-turno.md) (v1.1) | `hu` | `HU-064` | [#120](https://github.com/bcaceres19/barberia/issues/120) | `in_progress` | Todas implementadas, verificación pendiente en CI | `feat/120-hu064-detalle-historial-turno`; PR abierto, pendiente de CI |
