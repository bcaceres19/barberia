...
| [PROMPT-HU-040-v1](hu/hu-040-horario-laboral.md) (v1.2) | `hu` | `HU-040` | [#90](https://github.com/bcaceres19/barberia/issues/90) | `in_progress` | B1 cerrado; `CT-008` resuelta (`DEC-070`) | Rama `feat/90-hu040-horario-laboral`; PR pendiente de abrir |
