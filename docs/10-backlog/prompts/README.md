...
| [PROMPT-HU-006-v1](hu/hu-006-sesion-persistente.md) (v1.2) | `hu` | `HU-006` | [#45](https://github.com/bcaceres19/barberia/issues/45) | `in_progress` | `HU-005` integrada (PR #49); `CT-003` resuelta (`DEC-055`); `DP-SEG-08` resuelta (`DEC-058`) | `feat/45-hu006-sesion-persistente` |
