...
| [PROMPT-HU-010-v1](hu/hu-010-pantalla-acceso.md) (v1.1) | `hu` | `HU-010` | [#46](https://github.com/bcaceres19/barberia/issues/46) | `in_progress` | `HU-005`/`HU-009` integradas (ambas ya en `main`); `CT-004` resuelta (`DEC-056`) | `feat/46-hu010-pantalla-acceso` / — |
