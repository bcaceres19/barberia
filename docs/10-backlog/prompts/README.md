...
| [PROMPT-FIX-188-ACCESO-RECUPERACION-FIDELIDAD-v1](fix/issue-188-acceso-recuperacion-fidelidad-v1.md) | `fix` | `HU-010`; relacionadas `HU-005`, `HU-007`–`HU-009`, `HU-011` | [#188](https://github.com/bcaceres19/barberia/issues/188) | `in_progress` | Atlas #183, protocolo de fidelidad #208/PR #209 y rediseño inicial #206/PR #207 integrados | Rama `fix/188-acceso-recuperacion-fidelidad`; exige Claude Sonnet 5/high, Chrome DevTools, medición 1440/360 y autocorrección con baseline/final/lado a lado/overlay hasta `PASS` |
