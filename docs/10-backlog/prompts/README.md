...
| [PROMPT-CHORE-CONTROLES-REGLADOS-SHARED-UI-v1](chore/issue-pending-controles-reglados-shared-ui.md) | `chore` | `HU-009`; relacionadas `HU-010`–`HU-012` | [#212](https://github.com/bcaceres19/barberia/issues/212) | `executed` | Fase 1 de `PROMPT-ORCH-LENGUAJE-REGLADO-NAVA-v1`. Solo visual: campo reglado, `OtpInput` nuevo, alerta como nota al margen y botones en `shared/ui`, más barrido de regresión en las once rutas P0. Exige Claude Sonnet 5/high y las skills `nava-mockup-fidelity` + `browser-viewport-verification` | Rama `chore/212-controles-reglados-shared-ui`; PR [#214](https://github.com/bcaceres19/barberia/pull/214) abierto |
| [PROMPT-CHORE-FIDELIDAD-ACCESO-RECUPERACION-v1](chore/issue-pending-fidelidad-acceso-recuperacion.md) | `chore` | `HU-010`; relacionadas `HU-005`, `HU-007`, `HU-008`, `HU-011` | [#213](https://github.com/bcaceres19/barberia/issues/213) | `blocked` | Fase 2 de `PROMPT-ORCH-LENGUAJE-REGLADO-NAVA-v1`. Solo visual: composición de `/acceso` y `/recuperar-acceso` en los 23 eventos × 2 viewports. Ante diferencia de texto o comportamiento manda el código y se registra la desviación. Excluye la configuración de canal de `DEC-081` | Rama prevista `chore/213-fidelidad-acceso-recuperacion`; bloqueado hasta que #212 esté integrado en `main` |
