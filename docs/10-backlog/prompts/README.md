...
| [PROMPT-TEST-OTP-EMAIL-RESEND-v1](test/issue-86-otp-correo-resend.md) | `test` | `HU-008`, `HU-011` | [#86](https://github.com/bcaceres19/barberia/issues/86) | `in_progress` | Adaptador de correo único, selección por ambiente y pruebas automatizadas listos; prueba manual con correo real pendiente (requiere credenciales Resend del operador, no se ejecuta desde el agente) | Rama `test/86-otp-correo-resend`; PR pendiente de abrir con `Refs #86` |
