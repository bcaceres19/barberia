...
| [PROMPT-HU-065-v1](hu/hu-065-reprogramacion-turno.md) (v1.2) | `hu` | `HU-065` | [#123](https://github.com/bcaceres19/barberia/issues/123) | `in_progress` | Todas implementadas, verificación pendiente en CI | `feat/123-hu065-reprogramacion-turno`; PR abierto, pendiente de CI |
