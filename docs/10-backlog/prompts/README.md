...
| [PROMPT-HU-004-v1](hu/hu-004-idempotencia.md) | `hu` | `HU-004` | [#40](https://github.com/bcaceres19/barberia/issues/40) | `in_progress` | `HU-003` integrada | `feat/40-hu004-idempotencia` / — |
