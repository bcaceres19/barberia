...
| --- | --- | --- | --- | --- | --- | --- |
| [PROMPT-ORCH-NAVA-FRONTEND-v1.4](orchestration/adopcion-frontend-nava.md) | `orchestration` | `HU-005`–`HU-012`, `HU-020`–`HU-024`, `HU-040`–`HU-042`, `HU-060`–`HU-065`; futuras solo con HU real | [#168](https://github.com/bcaceres19/barberia/issues/168) | `ready` | `DEC-077`–`DEC-079` integradas en `main` (issue #166/PR #167). Las cuatro fases hijas de pantalla detectadas en la Fase 0 (configuración #170, servicios por barbero #172, detalle/historial/reprogramación #173, servicios #171) están integradas; la Fase 13 (revisión integral, #174) está en PR, última pendiente antes de cerrar #168. Hallazgo del shell (dock trunca a 320/360 px) registrado aparte en #176 | Sin rama/PR propios; prompt maestro para Claude Code, no autoriza una migración masiva |
...
| [PROMPT-TEST-174-REVISION-INTEGRAL-NAVA-v1](test/issue-174-revision-integral-nava.md) | `test` | `HU-005`–`HU-012`, `HU-020`–`HU-024`, `HU-040`–`HU-042`, `HU-060`–`HU-065` | [#174](https://github.com/bcaceres19/barberia/issues/174) | `ready` | Fase 13, última del issue maestro #168; recorrido real de las 11 rutas P0 con `axe-core` en vivo (0 violaciones) y sin defectos nuevos | Rama `test/174-revision-integral-nava`; sin PR todavía |
