...
| [PROMPT-HU-009-v1](hu/hu-009-sistema-visual.md) | `hu` | `HU-009` | [#42](https://github.com/bcaceres19/barberia/issues/42) | `in_progress` | Secuencia tras `HU-004` | `feat/42-hu009-sistema-visual` / — |
