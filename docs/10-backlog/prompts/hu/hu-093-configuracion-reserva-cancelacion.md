...
pr: null
pr_url: null
depends_on: ["B3 cerrado", "DP-PUB-02 resuelta mediante DEC-*", "Issue real con CA-093-01 a CA-093-05"]
...
No ejecutes este prompt hasta que `DP-PUB-02` fije rangos y defaults faltantes. Implementa solo configuración; no cambies citas.
