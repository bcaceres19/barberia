...
| `CT-011` | B4 debe confirmar por correo con enlace, pero B5 —posterior— es dueño de notificaciones y recordatorios | **Resuelta** | `DEC-091` | Cerrada el 2026-09-15 |
...
- **Resolución:** opción (1) elegida el 2026-09-15 como `DEC-091`: `HU-097` envía el correo real de confirmación de forma síncrona y simple con el proveedor ya integrado y verificado (Resend), sin cola ni reintentos; B5 construye después la maquinaria completa sobre esa base.
- **Evidencia:** `alcance-mvp.md` (`F-PUB-07`), `DEC-022`, `DEC-091`, `plan-bloques.md` (B4/B5), `historias-usuario.md` (`HU-097`, `HU-098`).
...
### CT-009 · Recuperación por dos canales frente a un único canal por código

- **Detectada y registrada:** 2026-09-02, al recoger la solicitud del propietario sobre la experiencia de recuperación de acceso.
- **Estado:** **Abierta**.
- **Responsable de resolver:** propietario del proyecto.
- **Documentos en conflicto:** `DEC-051`/`DEC-066` y `CA-008-01` describen el envío del código de recuperación por correo y WhatsApp; la solicitud nueva pide una opción mutuamente excluyente para enviar por correo electrónico o WhatsApp, nunca ambos en el mismo envío.
