...
// módulo, sin crear un segundo guard ni un árbol de rutas paralelo) y una
// función estrecha para que un módulo hermano actualice el nombre de la
// barbería ya confirmado por el servidor (`updateBarbershopName`, HU-020).
// Los componentes, el estado y el cliente API internos permanecen
// privados.
