...
## Corpus Check
- 108 files · ~86,694 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 485 nodes · 659 edges · 53 communities (48 shown, 5 thin omitted)
...
6. `Estados de las citas y máquina de transiciones` - 21 edges
...
Cohesion: 0.07
Nodes (56): Atlas CLI, DEC-016, Flyway, golang-migrate, Goose, JSON Schema Draft 2020-12, OpenAPI Specification 3.1.2, Redocly CLI (+48 more)
...
Cohesion: 0.08
Nodes (38): F-NOT-03: Recordatorios automáticos (P0), DEC-005: Anticipación mínima y ventana máxima elevadas a P0, DEC-010: Política de cancelación fuera de plazo elevada a P0, DEC-032: Recordatorios automáticos elevados a P0 (resuelve CT-001), Sistema de prioridades y clasificación de funciones, DEC-018: Valores iniciales de configuración, DEC-020: Bloqueos recurrentes y calendario colombiano activable, DEC-027: Correo y WhatsApp oficial como canales del MVP (+30 more)
...
Cohesion: 0.10
Nodes (12): components/headers README, components/parameters README, components/responses README, components/schemas README, components/security-schemes README, examples README, api/openapi README, database/migrations README (+4 more)
...
Cohesion: 0.11
Nodes (19): 1. Cómo leer este documento, 2. Estado del catálogo, 3. Bloque B0 · Cimientos, seguridad y primeras pantallas, 4. Historias pendientes de redacción, 5. Dudas que bloquean historias de B0, Convención de las tablas de cabecera, Historias de usuario y criterios de aceptación, HU-001 · Esquema inicial con aislamiento por barbería (+11 more)

### Community 52 - "3. Prompts por historia"
Cohesion: 0.11
Nodes (18): 1. Cómo usar estos prompts, 2. Preámbulo obligatorio, 3. Prompts por historia, 4. Prompt de revisión, 5. Mantenimiento de este documento, Prompt de `HU-001` · Esquema inicial con aislamiento por barbería, Prompt de `HU-002` · Contexto de barbería en cada solicitud, Prompt de `HU-003` · Contrato HTTP base y registro sin datos personales (+10 more)

## Knowledge Gaps
- **180 isolated node(s):** `system-barbershop`, `Clock`, `requestIDKey`, `semi`, `singleQuote` (+175 more)
...
- **Why does `Reglas de negocio` connect `Reglas de negocio` to `Estados de las citas y máquina de transiciones`?**
  _High betweenness centrality (0.142) - this node is a cross-community bridge._
- **Why does `Respuestas a dudas pendientes del proyecto` connect `Respuestas a dudas pendientes del proyecto` to `Reglas de negocio`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `Estándar de documentación OpenAPI` connect `Estados de las citas y máquina de transiciones` to `Matriz de trazabilidad`, `Reglas de negocio`?**
...
- **Should `Estados de las citas y máquina de transiciones` be split into smaller, more focused modules?**
