...
## Corpus Check
- 692 files · ~2,746,742 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6845 nodes · 14712 edges · 416 communities (364 shown, 52 thin omitted)
- Extraction: 80% EXTRACTED · 20% INFERRED · 0% AMBIGUOUS · INFERRED: 2888 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5b4a671c`
...
## Communities (416 total, 52 thin omitted)
...
Cohesion: 0.13
Nodes (42): CT-001: Recordatorios automáticos ¿P0 o P1?, Dudas pendientes y resoluciones, Historial de cambios documentales, Matriz de trazabilidad, DEC-001: Referidos y comisiones fuera del MVP, DEC-002: Duración planificada vs duración real, DEC-003: Desactivación de servicios con citas futuras, DEC-004: Aplicación y comunicación de cambios de servicio (+34 more)
...
Cohesion: 0.16
Nodes (21): alwaysUnauthorized(), chiWalkFinds(), Handler, Mux, T, TestPrivateSubrouter_BypassingItSkipsTheMiddleware(), TestPrivateSubrouter_MiddlewareAppliesToRoutesRegisteredOnIt(), Logger (+13 more)
...
Cohesion: 0.16
Nodes (21): Request, ResponseWriter, newBarbershopSettingsResponse(), newProblem(), T, TestTranslate_Conflict_MapsTo409DistinctFromIdempotencyConflict(), TestTranslate_IdempotencyConflict_MapsTo409(), TestTranslate_IdempotencyLocked_MapsTo409WithoutWaiting() (+13 more)
...
### Community 51 - "Historias de usuario y criterios de aceptación"
Cohesion: 0.09
Nodes (23): 1. Cómo leer este documento, 2. Estado del catálogo, 4. Bloque B1 · Identidad de la barbería y catálogo, 5. Bloque B2 · Horario laboral y bloqueos, 6. Bloque B3 · Agenda, estados e integridad, 7. Historias pendientes de redacción, 8. Dudas que bloqueaban historias de B0, Convención de las tablas de cabecera (+15 more)
...
### Community 57 - "Load"
Cohesion: 0.17
Nodes (33): getEnv(), getEnvCSV(), getEnvDuration(), getEnvInt(), Duration, Load(), redactDSN(), requireTLS() (+25 more)
...
Cohesion: 0.14
Nodes (18): WorkingHour, Barber, CreateResult, Decision, StoredResponse, BarberPort, BlockRepository, CreateBlockResult (+10 more)
...
### Community 83 - "NewSessionService"
Cohesion: 0.18
...
Cohesion: 0.09
Nodes (29): clampHistoryLimit(), EncodeHistoryCursor(), Time, LooksLikeAppointmentID(), resolveActorLabel(), safeActorLabel(), AppointmentDetail, Context (+21 more)

### Community 87 - "NewPhoneChallengeService"
Cohesion: 0.05
Nodes (75): NewChallengeHandler(), NewChallengeVerifyHandler(), Context, T, Time, newChallengeHandler(), newVerifyHandler(), testChallengeCfg() (+67 more)
...
Cohesion: 0.13
Nodes (14): Time, TimeBlock, TimeBlockSeries, Context, fakeRepository, Time, TimeBlock, TimeBlockSeries (+6 more)
...
### Community 122 - "Status"
Cohesion: 0.24
Nodes (9): AppointmentDetail, DailyAgendaEntry, Row, newRescheduleAppointment(), parsePriceAmount(), scanAppointment(), scanAppointmentDetail(), scanDailyAgendaEntry() (+1 more)
...
### Community 141 - "createTestSession"
Cohesion: 0.35
...
Cohesion: 0.07
Nodes (27): Alcance incluido, Cambios, Criterios de aceptación, Diagnosticar y eliminar la flakiness de integración Go, Entrega, Fuera de alcance, Hipótesis y resultado, Instrucción (resuelta 2026-09-04) (+19 more)
...
### Community 177 - ".Verify"
Cohesion: 0.12
Nodes (16): Time, NormalizeEmail(), errInvalidCredentials(), HMACHex(), MaskEmail(), MaskPhone(), T, TestMaskEmail() (+8 more)
...
Cohesion: 0.16
Nodes (18): Time, ListResult, Request, ResponseWriter, Service, newServiceListResponse(), newServiceResponse(), principalOrInternalError() (+10 more)
...
Cohesion: 0.13
Nodes (23): DefaultCookieConfig(), NewLoginHandler(), Context, Repository, T, Time, newLoginHandlerWithThrottle(), TestLoginHandler_Escalated_Returns429WithRetryAfterAndNeverTouchesRepository() (+15 more)
...
Cohesion: 0.12
Nodes (29): LooksLikeSeriesID(), LooksLikeTimeBlockID(), ValidateCivilDate(), ValidateEffectiveRange(), errDateInvalid(), errDateOutOfSeriesRange(), errDuplicateSeriesDate(), errDuplicateSeriesException() (+21 more)
...
### Community 234 - "testRouterConfig"
Cohesion: 0.38
...
Cohesion: 0.17
Nodes (25): Repository, NewManualBookingService(), errUnexpectedCall(), T, TestCreateManualAppointment_ActiveBlock_ReturnsConflictWithoutCallingRepository(), TestCreateManualAppointment_MissingBarberID_RejectsWithoutTouchingPorts(), TestCreateManualAppointment_NoPhoneNoEmail_NeverReconciles_AlwaysNewCustomer(), TestCreateManualAppointment_NoPhoneWithEmail_ReconciliatesByEmail() (+17 more)
...
### Community 250 - "stubRepository"
Cohesion: 0.24
Nodes (5): AppointmentDetail, Context, DailyAgendaEntry, Time, stubRepository
...
Cohesion: 0.17
Nodes (18): Request, ResponseWriter, decodeJSONBody(), Request, ResponseWriter, T, parseIncludeDeleted(), Request (+10 more)

### Community 254 - "DEC-038: Flujo de ramas, commits y pull requests"
Cohesion: 0.17
Nodes (13): OpenAPI contract changelog, OpenAPI entry document, database/migrations README, database README, database/seeds README, database/testdata README, database/tests README, DEC-038: Flujo de ramas, commits y pull requests (+5 more)
...
Cohesion: 0.14
Nodes (28): buildRouter(), Logger, Mux, main(), run(), selectRecoverySender(), exceptionBasePath(), Service (+20 more)
...
Cohesion: 0.11
Nodes (26): clampBlockLimit(), LooksLikeBarberID(), LooksLikeWorkingHourID(), errBarberNotFound(), errDurationInvalid(), errISOWeekdayInvalid(), errOverlapConflict(), errStartsTimeInvalid() (+18 more)
...
### Community 267 - "RequestLogger"
Cohesion: 0.19
Nodes (9): Time, Handler, Logger, RequestLogger(), findForbiddenPattern(), T, TestFindForbiddenPattern_DetectsPoisonedLine(), TestRequestLogger_OnlyAllowedFieldsAndNoForbiddenContent() (+1 more)
...
Cohesion: 0.14
Nodes (34): seriesDateBody, seriesExceptionBody, timeBlockBody, timeBlockListBody, timeBlockSeriesBody, doJSONRequest(), Handler, ResponseRecorder (+26 more)
...
Cohesion: 0.33
Nodes (7): Barber, Context, CreateResult, Cursor, fakeRepository, ListResult, RenameResult
...
Cohesion: 0.29
Nodes (12): expectValidationErr(), T, repeatChar(), strPtr(), TestBookingService_CreateInternal_RejectsInvalidInputWithoutCallingRepository(), TestBookingService_CreateInternal_ValidInputPassesValidation(), TestStatus_OccupiesSchedule(), validInput() (+4 more)

### Community 280 - "booking/postgres/repository.go"
Cohesion: 0.12
Nodes (37): appointmentExists(), errAppointmentNotConfirmed(), errAppointmentNotFound(), errBarberNotFound(), errCustomerEmailTaken(), errCustomerNotFound(), errCustomerPhoneTaken(), errScheduleConflict() (+29 more)
...
### Community 300 - "EncodeVersionToken"
Cohesion: 0.31
...
### Community 301 - "NewAgendaService"
Cohesion: 0.16
Nodes (28): BarberPort, Repository, NewAgendaService(), Context, DailyAgendaEntry, T, Time, TestListDailyAgenda_BarberDoesNotExist_ReturnsNotFound() (+20 more)

### Community 302 - "assertKind"
Cohesion: 0.20
Nodes (25): NewDetailService(), T, TestGetDetail_BarberNameNotFound_LeavesFullNameEmpty(), TestGetDetail_BarberNamePortError_ReturnsInternal(), TestGetDetail_Found_ResolvesBarberFullName(), TestGetDetail_MalformedAppointmentID_RejectsWithoutTouchingRepository(), TestGetDetail_NotFound_ReturnsNotFound(), TestGetDetail_RepositoryError_ReturnsInternal() (+17 more)
...
Cohesion: 0.21
Nodes (24): Repository, T, newDetailService(), TestGetAppointmentDetailHandler_NoPrincipal_Returns500(), TestGetAppointmentDetailHandler_NotFound_Returns404(), TestGetAppointmentDetailHandler_RepositoryError_Returns500(), TestGetAppointmentDetailHandler_ValidRequest_Returns200WithDetail(), TestListAppointmentHistoryHandler_AppointmentNotFound_Returns404() (+16 more)
...
### Community 312 - "RecoveryRepository"
Cohesion: 0.46
...
Cohesion: 0.13
Nodes (23): Time, formatPriceAmount(), AppointmentDetail, DailyAgendaEntry, HistoryChange, newAppointmentDetailResponse(), newAppointmentHistoryChangeResponses(), newAppointmentHistoryResponse() (+15 more)
...
### Community 318 - "DB"
Cohesion: 0.12
Nodes (15): Context, Context, NewPurgeRepository(), T, setupWorkerTestDB(), TestPurgeRepository_PurgeLoginThrottle_DeletesOnlyExpired(), TestPurgeRepository_PurgePhoneChallenges_RunsWithoutError(), TestPurgeRepository_PurgeRecoveryCodes_RunsWithoutError() (+7 more)
...
### Community 321 - "3. Bloque B0 · Cimientos, seguridad y primeras pantallas"
Cohesion: 0.15
...
### Community 326 - "Error"
Cohesion: 0.14
Nodes (17): Error, Kind, Context, errAppointmentNotConfirmed(), errVersionConflict(), ChallengeRequired(), IdempotencyConflict(), IdempotencyLocked() (+9 more)

### Community 327 - "README.md — Sistema de agenda para barberías"
Cohesion: 0.33
Nodes (10): AGENTS.md — Reglas de desarrollo del proyecto, apps/api README, apps/web README, CONTRIBUTING.md — Cómo contribuir, Registro de contradicciones, Glosario y convenciones de nombres, Registro de decisiones, DEC-039: Sistema visual y composición de pantallas (+2 more)
...
### Community 364 - "catalog/errors.go"
Cohesion: 0.13
...
Cohesion: 0.05
Nodes (67): Logger, NewRecoveryRequestHandler(), NewRecoveryResetPasswordHandler(), NewRecoveryVerifyHandler(), discardRecoveryLogger(), Context, Logger, RecoveryRepository (+59 more)

### Community 368 - "Mockups de `/panel/turnos/:appointmentId` (detalle, historial y reprogramación) por viewport y evento"
Cohesion: 0.05
Nodes (33): Criterio | Estado | Evidencia, Decisiones que sí cambian código, y por qué, Desviaciones de `/panel/turnos/nuevo` frente al atlas `nuevo-turno-eventos`, Diferencia | Autoridad | Tratamiento, Evidencia que sustenta esta tabla, Contrato visual común, Detalle del turno (`/panel/turnos/:appointmentId`), Diferencias con la lámina compuesta (+25 more)
...
Cohesion: 0.12
Nodes (19): NewCustomerInput, Time, AppointmentDetail, Context, DailyAgendaEntry, Time, Context, Actor (+11 more)
...
### Community 390 - "block_repository.go"
Cohesion: 0.60
...
Cohesion: 0.09
Nodes (32): Request, ResponseWriter, NewLogoutHandler(), T, newLogoutHandler(), TestLogoutHandler_MissingPrincipalInContext_ReturnsSafe500(), TestLogoutHandler_ServiceFailure_ReturnsSafe500(), TestLogoutHandler_Success_RevokesAndClearsCookie() (+24 more)
...
## Knowledge Gaps
- **2015 isolated node(s):** `holidayCalendarBody`, `deactivationImpactBody`, `system-barbershop`, `schemaDoc`, `ChallengeRequest` (+2010 more)
...
- **Why does `buildRouter()` connect `buildRouter` to `createBarberViaRouter`, `block_handler.go`, `.Now`, `NewRouter`, `catalog_integration_test.go`, `TestServiceLifecycle_HTTP_PreviewDeactivateReactivate_FullJourney`, `uniqueToken`, `TestWorkingHours_HTTP_CreateListGetUpdateDelete_FullJourney`, `Principal`, `NewThrottleService`, `setupTestDB`, `buildRouterWithRecoveryCapture`, `NewBarberLookup`, `NewRecoveryRepository`, `NewManualBookingBlocks`, `NewTimezoneLookup`, `staff/httpapi/handler_test.go`, `NewAgendaService`, `assertKind`, `requestWithPrincipal`, `booking/httpapi/handler_test.go`, `HashToken`, `ThrottleService`, `booking/httpapi/handler.go`, `NewSQLCoordinator`, `DB`, `NewBarberNameLookup`, `NewStaffActorNameLookup`, `NewAssignmentService`, `schedule/httpapi/handler.go`, `NewLoggingPhoneCodeSender`, `NewSessionService`, `NewPhoneChallengeService`, `catalog/httpapi/handler_test.go`, `testThrottleIPHash`, `AssignmentRepository`, `NewService`, `testRouterConfig`, `discardLogger`, `RecoveryService`, `CatalogService`, `NewManualBookingService`?**
  _High betweenness centrality (0.090) - this node is a cross-community bridge._
- **Why does `DB` connect `DB` to `buildRouter`, `catalog/postgres/repository.go`, `createTestSession`, `setupTestDB`, `buildRouterWithRecoveryCapture`, `Repository`, `booking/postgres/repository.go`, `Repository`, `NewRecoveryRepository`, `createServiceFixture`, `setupTestDB`, `setupTestDB`, `IdempotencyKeyFromRequest`, `database_test.go`, `RecoveryRepository`, `setupTestDB`, `NewSQLCoordinator`, `.Create`, `testThrottleIPHash`, `catalog/httpapi/contract_test.go`, `AssignmentRepository`, `setupTestDB`, `NewService`, `testRouterConfig`, `Key`, `setupTestDB`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `As()` connect `As` to `principalOrInternalError`, `catalog/postgres/repository.go`, `Translate`, `NewThrottleService`, `.Now`, `idempotency/idempotency_test.go`, `schedule/service_test.go`, `NewBarberLookup`, `booking/domain_test.go`, `booking/postgres/repository.go`, `createServiceFixture`, `NewService`, `assertKind`, `setupTestDB`, `IdempotencyKeyFromRequest`, `principalOrInternalError`, `DecodeCursor`, `NewSQLCoordinator`, `block_service_test.go`, `NewService`, `NewBarberNameLookup`, `NewAssignmentService`, `Error`, `.Create`, `NewSessionService`, `NewPhoneChallengeService`, `RequestID`, `NewService`, `Key`, `catalog/domain_test.go`, `setupTestDB`, `Context`, `WriteProblem`?**
